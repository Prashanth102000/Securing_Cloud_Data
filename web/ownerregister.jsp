...
<%
        ...
        %>
        <script>alert('Owner Registration succesfully');</script>
        <%            }
        %>
        <%
    ...
    <div id="tooplate_header"><br></br>
        ...
        <div id="tooplate_menu">
            ...
            <ul>
                 ...
                 <li><a href="ownerlogin.jsp" class="current">LOGIN</a></li>
                <li><a href="ownerregister.html">REGISTRATION</a></li>
            </ul>    		
...
<div id="tooplate_middle_wrapper1">
	<div id="tooplate_middle_wrapper2">
		<div id="tooplate_middlereglogin">
...
<div class="container profile" class="page-wrapper" style="border-style:   groove; border-width: 10px;border-color: #E9967A;height:  600px;width: 800px;margin-left: 250px;" >
    <center><h1 style="font-family: Copperplate Gothic Bold;color:#3CB371 ">Data Owner Registration</h1></center>
  <div style="float: left; margin-left: 10px;background:#696969;width: 340px" >
                    ...
                    <br><form name="frm" onsubmit="return validate()"  action="login.jsp" method="post"> 
                        ...
                        <input type="text" class="inputs" name="phone"  placeholder="PHONENUMBER" pattern="[6789][0-9]{9}" /><br>
                        ...
                        <br><input type="hidden" value="5" name="status" />
