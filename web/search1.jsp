...
<%
        ...
        %>
        <script>alert('search key request has been send');</script>
        <%            }
        %>
        <%
            if (request.getParameter("msgg") != null) {
        %>
        <script>alert('search key request has been not send');</script>
        <%            }
        %>
        <%
            if (request.getParameter("msggg") != null) {
        %>
        <script>alert('Your Key is wrong');</script>
        <%            }
        %>
</head>
<body> 
...
<br></br>
<div class="container profile" class="page-wrapper" style="border-style:   groove; border-width: 10px;border-color: #E9967A;height:  310px;width: 800px;margin-left: 250px;" >
    <center><h1 style="font-family: Copperplate Gothic Bold;color:#3CB371 ">FILE SEARCH KEY </h1></center>
  ...
  <div style="float: left; margin-left: 10px;background:#696969;width: 390px" >
                    ...
                    <br><form action="login.jsp" method="post"> 
                            ...
                            <label STYLE="font-size: 25px;color:brown">SEARCH KEY</label><br></br><input type="text" class="inputs" name="searchkey" required=""  /><br> 
                        <a href="search2.jsp" style="text-decoration: none;color:blue;font-size: 20px">Key_Request</a><br><br><br>
    ...
    <div style="float: right; margin-right:  10px;background: blanchedalmond;width: 390px">
              <img style="width:400px;height: 210px"src="imagess\keys.png"></img>
          </div>
</div>
