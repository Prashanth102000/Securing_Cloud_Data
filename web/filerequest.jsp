...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        %>
        <script>alert('Request key has been send ');</script>
        <%            }
        %>
    ...
    <body> 
        ...
        <div class="container profile" class="page-wrapper" style="border-style:   groove; border-width: 10px;border-color: #E9967A;height:  400px;width: 920px;margin-left: 250px;overflow: auto" >
            <center><h1 style="font-family: Copperplate Gothic Bold;color:#3CB371 ">Search Request Details</h1></center>
            <div style=" margin-left: 10px;background:   #FAEBD7;width: 900px" >
                ...
                <table border="2" style="text-align: center; margin-left: 0px; border-color: black">
                    <tr>
                        ...
                        <th style="text-align: center;width: 400px;  font-size: 16px; color: brown">STATUS</th>

                        <th style="text-align: center;width: 200px;  font-size: 16px; color: brown">KEYSEND</th>
...
//                            
                            ...
                            try {
                                ...
                                while (rs.next()) {
                        %>
                        <td style="font-size: 16px"><br><%=rs.getString("usrename")%></td>  
                        <td style="font-size: 16px"><br><%=rs.getString("mailid")%></td>  
                        <td style="font-size: 16px"><br><%=rs.getString("status")%></td>   
                        <td><a href="filerequest2.jsp?<%=rs.getString("id")%>" style="text-decoration: none;color:blue;font-size: 20px">Respond</a></td>
