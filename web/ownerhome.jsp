...
String oid = ses.getAttribute("ouwwid").toString();
                            ...
                            try {
                                ...
                                rs = st.executeQuery("select * from oreg where id='"+oid+"' ");
                                if (rs.next()) {
                        %>
<div class="container profile" class="page-wrapper" style="border-style:   groove; border-width: 10px;border-color: #E9967A;height:  300px;width: 500px;margin-left: 350px;" >
    <center><h1 style="font-family: Copperplate Gothic Bold;color:#3CB371 ">OWNER DETAILS</h1></center>
     ...
     <div style="float: left; margin-left: 20px;background:#696969;width: 460px" >
         ...
         <h2><%=rs.getString("ousernmae")%></h2>
         <h2><%=rs.getString("omailid")%></h2>
         <h2><%=rs.getString("ophone")%></h2>
         <h2><%=rs.getString("olocation")%></h2>
          </div>
    <%
                            }
                        } catch (Exception ex) {
