    ...
    <div id="tooplate_header"><br></br>
        ...
        <div id="tooplate_menu">
            ...
            <ul>
                ...
                <li><a href="ownerlogin.jsp">DATA_OWNER</a></li>
...
<br></br>
<div class="container profile" class="page-wrapper" style="border-style:   groove; border-width: 10px;border-color: #E9967A;height:  400px;width: 900px;margin-left: 250px;" >
    
  
    <div style="float: right; margin-right:  570px;background: blanchedalmond;width: 320px">
              <img style="width:870px;height: 380px"src="imagess\sec.png"></img>
          </div>
</div>
