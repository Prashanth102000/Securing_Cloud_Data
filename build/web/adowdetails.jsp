...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body> 
        ...
        <div class="container profile" class="page-wrapper" style="border-style:   groove; border-width: 10px;border-color: #E9967A;height:  400px;width: 920px;margin-left: 250px;overflow: auto" >
            <center><h1 style="font-family: Copperplate Gothic Bold;color:#3CB371 ">Owner Details</h1></center>
...
//                            
                            ...
                            try {
                                ...
                                while (rs.next()) {
                        %>
                        <td style="font-size: 16px"><br><%=rs.getString("ousernmae")%></td>  
                        <td style="font-size: 16px"><br><%=rs.getString("omailid")%></td>  
                        <td style="font-size: 16px"><br><%=rs.getString("olocation")%></td>   
                        <td style="font-size: 16px"><br><%=rs.getString("ophone")%></td>
                        <td style="font-size: 16px"><br><%=rs.getString("ogender")%></td>
                        <td style="font-size: 16px"><br><%=rs.getString("regdata")%></td>
                        <td><a href="activate.jsp?<%=rs.getString("id")%>" style="text-decoration: none;color:blue;font-size: 20px">ACTIVATE</a></td>
                           <td><a href="deactivate.jsp?<%=rs.getString("id")%>" style="text-decoration: none;color:blue;font-size: 20px">DEACTIVATE</a></td>
