    ...
    <div id="tooplate_header"><br></br>
        ...
        <div id="tooplate_menu">
            ...
            <ul>
                ...
                <li><a href="search3.jsp" class="current">Back</a></li>
...
<br></br>
<div class="container profile" class="page-wrapper" style="border-style:   groove; border-width: 10px;border-color: #E9967A;height:  450px;width: 800px;margin-left: 250px;" >
    <center><h1 style="font-family: Copperplate Gothic Bold;color:#3CB371 ">FILE VIEW   </h1></center>
     <%

//                            
                            
                            
                            String filid = request.getQueryString();
                            Connection con = null;
                            Statement st = null;
                            ResultSet rs = null;
                            try {
                                ...
                                rs = st.executeQuery("select * from fileupload where id='"+filid+"'  ");
                                while (rs.next()) {
                                    String namee=rs.getString("fcaption");
                                     StringBuffer sb=new StringBuffer();
                                     InputStream is=rs.getAsciiStream("filess");
    ...
    <center><h1 style="font-family: Copperplate Gothic Bold;color:#3CB371 "><%=namee%> </h1></center>     
  <div style="float: left; margin-left: 10px;background:#696969;width: 390px" >
      
                    <br><form action="login.jsp" method="post"> 
                            <label STYLE="font-size: 25px;color:brown">FILE CONTENT</label><br><br></br>
                                <textarea name="signature" cols="50" rows="13"><%=text%></textarea><br><BR>
                            
                        
                        <br><input type="hidden" value="6" name="status" />
    ...
    <div style="float: right; margin-right:  10px;background: blanchedalmond;width: 390px">
              <img style="width:400px;height: 325px"src="imagess\fileview.ico"></img>
          </div>
</div>
