                ...
                <table border="2" style="text-align: center; margin-left: 0px; border-color: black">
                    <tr>
                        ...
                        <th style="text-align: center;width: 200px;  font-size: 16px; color: brown">DATE</th>
                         <th style="text-align: center;width: 200px;  font-size: 16px; color: brown">STATUS</th>
                        <th style="text-align: center;width: 200px;  font-size: 16px; color: brown">Key_generate</th>
                        <th style="text-align: center;width: 200px;  font-size: 16px; color: brown">view</th>
                        <th style="text-align: center;width: 200px;  font-size: 16px; color: brown">Download</th>
...
//                            
                        ...
                        <td style="font-size: 16px"><br><%=rs.getString("dates")%></td>
                        <td style="font-size: 16px;text-decoration: none;color:red; "><br><%=rs.getString("statuss")%></td>
                        
                         <td><a href="keygenerate.jsp?<%=rs.getString("id")%>" style="text-decoration: none;color:blue;font-size: 20px">KEYGENERATE</a></td>
                        <td><a href="owfileview.jsp?<%=rs.getString("id")%>" style="text-decoration: none;color:blue;font-size: 20px">view</a></td>
                           <td><a href="ofiledown.jsp?<%=rs.getString("id")%>" style="text-decoration: none;color:blue;font-size: 20px">Download</a></td>
