...
<%
        ...
        %>
        <script>alert('key has been checked');</script>
        <%            }
        %>
...
<div class="container profile" class="page-wrapper" style="border-style:   groove; border-width: 10px;border-color: #E9967A;height:  310px;width: 800px;margin-left: 250px;" >
    <center><h1 style="font-family: Copperplate Gothic Bold;color:#3CB371 ">FILE SEARCH  </h1></center>
  ...
  <div style="float: left; margin-left: 10px;background:#696969;width: 390px" >
                    ...
                    <br><form action="viewfiless.jsp" method="post"> 
                            <br>
                            <label STYLE="font-size: 25px;color:brown">Filename</label><br></br><input type="text" class="inputs" name="filename" required=""  /><br> 
